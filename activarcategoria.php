  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="section section-lg bg-gray-1 contacto-login" id="contacts">
        <div class="container">
              <h2 class="text-center text-sm-start">¿Desea activar esta categoría?</h2>
              <!-- RD Mailform-->
              <form class="form-login" method="post" action="activarcategoria.php?codigo=<?php echo $codigo; ?>">
