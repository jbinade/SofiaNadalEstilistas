...
?>
        ...
        <body>
            ...
            <section class="section section-lg bg-gray-1 contacto-login" id="contacts">
                <div class="container">
                    <h2 class="text-center text-sm-start">Editar Mi Cuenta</h2>
                    <!-- RD Mailform-->
                        <form class="form-login" method="post" action="editarmicuenta.php">
                                ...
                                <div class="form-wrap rd-form-2-2">
                                    <input class="form-input" id="nombre" type="text" name="nombre" value="<?php echo $datos->nombre; ?>" required>
                                ...
                                <div class="form-wrap rd-form-2-2">
                                    <input class="form-input" id="apellidos" type="text" name="apellidos" value="<?php echo $datos->apellidos; ?>" required>
                                ...
                                <div class="form-wrap rd-form-2-2">
                                    <input class="form-input" id="contrasena" type="telefono" name="telefono" value="<?php echo $datos->telefono; ?>" required>
                                    <label class="form-label" for="contrasena">Teléfono</label>
                                    <?php 
                                ...
                                <div class="row justify-content-between align-items-center">
                                    ...
                                    <div class="col-12 col-sm-9 col-lg-10"> <!-- Se ocupa la mitad del ancho en escritorio y tablet -->
                                        <a href="micuenta.php"><button class="button button-third" type="submit">Volver</button></a>
                                    </div>
                                </div>
