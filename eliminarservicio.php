...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = $conexion->prepare('UPDATE servicios SET activo = 0 WHERE codigo = :codigo');
  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="section section-lg bg-gray-1 contacto-login" id="contacts">
        <div class="container">
              <h2 class="text-center text-sm-start">¿Desea eliminar este servicio?</h2>
              <!-- RD Mailform-->
              <form class="form-login" method="post" action="eliminarservicio.php?codigo=<?php echo $codigo; ?>">
                <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-12 col-sm-9 col-lg-10"> <!-- Se ocupa la mitad del ancho en escritorio y tablet -->
                                <a href="servicios.php"><button class="button button-third" type="submit">No, volver atrás</button></a>
                            </div>
