                    ...
                    <?php
                        ...
                        try {
                            ...
                            while ($res = $stmt->fetch(PDO::FETCH_OBJ)) {
                                ...
                                echo "<td><a href='editarempleado.php?dni=" . $res->dni . "'><img class='imagen-tabla' src='./images/editar.png' alt='Editar'></a></td>";
                                echo "<td><a href='eliminarempleado.php?dni=" . $res->dni . "'><img class='imagen-tabla' src='./images/borrar.jpg' alt='Borrar'></a></td>";
                                echo "</tr>";
                                echo "</tr>";
                            }
                        echo "</table>";
