                ...
                <div class="container">
                    ...
                    <!-- RD Mailform-->
                        <form class="form-login" method="post" action="editardatosAdmin.php">
                                ...
                                <div class="form-wrap rd-form-2-2">
                                    <input class="form-input" id="telefono" type="text" name="telefono" value="<?php echo $datos->telefono; ?>" required>
        ...
        <div class="container">
              ...
              <!-- RD Mailform-->
                <form class="form-login" method="post" action="editardatosAdmin.php">
                        ...
                        <div class="form-wrap rd-form-2-2">
                            <input class="form-input" id="telefono" type="telefono" name="telefono" value="<?php echo $datos->telefono; ?>" required>
                            <label class="form-label" for="telefono">Teléfono</label>
                        </div>
