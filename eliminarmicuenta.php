  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="section section-lg bg-gray-1 contacto-login" id="contacts">
        <div class="container">
              <h2 class="text-center text-sm-start">¿Desea eliminar su cuenta?</h2>
              <!-- RD Mailform-->
              <form class="form-login" method="post" action="eliminarmicuenta.php">
                <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-12 col-sm-9 col-lg-10"> <!-- Se ocupa la mitad del ancho en escritorio y tablet -->
                                <a href="micuenta.php"><button class="button button-third" type="submit">No, volver atrás</button></a>
                            </div>
