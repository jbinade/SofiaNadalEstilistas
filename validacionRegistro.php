            ...
            <body>
                ...
                <section class="section section-lg bg-gray-1 contacto-login" id="contacts">
                    ...
                    <div class="row justify-content-left justify-content-lg-between row-2-columns-bordered row-50">
                        ...
                        <!-- RD Mailform-->
                            <form class="rd-form rd-mailform form-login" method="post" action="validacionRegisto.php">
                                    <div class="form-wrap rd-form-2-2">
                                        <input class="form-input" id="contact-name" type="text" name="name" data-constraints="@Required">
                                        <label class="form-label" for="contact-name">DNI</label>
                                        <?php 
                                            if (isset($fallos["dni"])) { 
                                    ...
                                    <div class="form-wrap rd-form-2-2">
                                        <input class="form-input" id="contact-name" type="text" name="name" data-constraints="@Required">
                                        <label class="form-label" for="contact-name">Apellidos</label>
                                        <?php 
                                    ...
                                    <div class="form-wrap rd-form-2-2">
                                        <input class="form-input" id="contact-name" type="text" name="name" data-constraints="@Required">
                                        <label class="form-label" for="contact-name">Contraseña</label>
                                        <?php 
