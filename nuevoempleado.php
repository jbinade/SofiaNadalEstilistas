            ...
            <body>
                ...
                <section class="section section-lg bg-gray-1 contacto-login" id="contacts">
                    ...
                    <div class="row justify-content-left justify-content-lg-between row-2-columns-bordered row-50">
                        ...
                        <h2 class="text-center text-sm-start">Nuevo Empleado</h2>
                        <!-- RD Mailform-->
...
<?php
                ...
                try {
                    ...
                    if ($stmt->rowCount() > 0) {
                        ...
                        $stmtCliente = $conexion->prepare("UPDATE clientes SET nombre = :nombre, apellidos = :apellidos, telefono = :telefono, email = :email, contrasena = :contrasena, activo = 1 WHERE dni = :dni");
                        ...
                        'INSERT INTO clientes (dni, nombre, apellidos, telefono, rol, email, contrasena, activo) VALUES (:dni, :nombre, :apellidos, :telefono, :rol, :email, :contrasena, :activo)');
                        ...
                        $stmtRegistro->bindParam(':telefono', $telefono, PDO::PARAM_STR);
                        $stmtRegistro->bindParam(':rol', $rol, PDO::PARAM_STR);
      ...
      <section class="section section-lg bg-gray-1 contacto-login" id="contacts">
        <div class="container">
          <div class="row justify-content-left justify-content-lg-between row-2-columns-bordered row-50">
              ...
              <h2 class="text-center text-sm-start">Nuevo Empleado</h2>
              <!-- RD Mailform-->
                <form class="form-login" method="post" action="nuevoempleado.php">
                        <div class="form-wrap rd-form-2-2">
                        ...
                        <div class="form-wrap rd-form-2-2">
                            <input class="form-input" id="telefono" type="tel" name="telefono" pattern="[0-9]{9}" required>
                            <label class="form-label" for="telefono">Teléfono</label>
                        </div>
