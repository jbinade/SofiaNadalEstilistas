                ...
                <div class="card text-center">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                          <li class="nav-item">
                              <a class="nav-link" href="servicios.php">Servicios Disponibles</a>
                          </li>
                          <li class="nav-item">
                              <a class="nav-link active" aria-current="true" href="#">Servicios No disponibles</a>
                          </li>                       
                        </ul>
                    ...
                    <?php
                        ...
                        try {
                            ...
                            $stmt = $conexion->prepare("SELECT * FROM servicios WHERE activo = 0 LIMIT ".$inicio."," .$PAGS);
                            $stmt->execute();
                            ...
                            while ($res = $stmt->fetch(PDO::FETCH_OBJ)) {
                                ...
                                echo "<td><a href='activarservicio.php?codigo=" . $res->codigo . "'><img class='imagen-tabla' src='./images/editar.png' alt='Editar'></a></td>";
                                echo "</tr>";
                                echo "</tr>";
                            }
                        echo "</table>";
                    ...
                    if ($total_paginas > 1) {
                      for ($i = 1; $i <= $total_paginas; $i++) {
                          if ($pagina == $i) {
                              ...
                              echo "<a href='servnodisponible.php?pagina=$i'>$i</a> ";
                          }
                      }
                    }
                    ?>
