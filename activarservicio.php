...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = $conexion->prepare('UPDATE servicios SET activo = 1 WHERE codigo = :codigo');
  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="section section-lg bg-gray-1 contacto-login" id="contacts">
        <div class="container">
              <h2 class="text-center text-sm-start">¿Desea activar este servicio?</h2>
              <!-- RD Mailform-->
              <form class="form-login" method="post" action="activarservicio.php?codigo=<?php echo $codigo; ?>">
